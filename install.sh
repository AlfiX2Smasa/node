...
display_welcome() {
  ...
  echo -e ""
  echo -e "JANGAN LUPA SUBSCRIBE @ChGaje"
  echo -e ""
  echo -e "TQ TO :"
  echo -e "ALL CREATOR WHATSAPP"
  echo -e "ALFIOFFICIAL ( MY SELF )"
  sleep 4
  clear
}
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY ALFI OFFC             [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "alfismasa" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN} Silahkan Tanyakan Kepada AlfiOfficial Jika Token Salah.${NC}"
    exit 1
  fi
  clear
}
